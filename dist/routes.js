...
router.put('/order/enviar', isAuthenticated_1.isAuthenticated, new SendOrderController_1.SendOrderController().handle);
...
router.put('/order/update', isAuthenticated_1.isAuthenticated, new UpdateOrderController_1.UpdateOrderController().handle);
